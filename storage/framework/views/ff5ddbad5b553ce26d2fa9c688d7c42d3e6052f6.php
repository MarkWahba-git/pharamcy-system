<?php if((!isset($item['topnav']) || (isset($item['topnav']) && !$item['topnav'])) && (!isset($item['topnav_right']) || (isset($item['topnav_right']) && !$item['topnav_right'])) && (!isset($item['topnav_user']) || (isset($item['topnav_user']) && !$item['topnav_user']))): ?>
    ...
    <?php endif; ?>
<?php endif; ?>
<?php /**PATH /home/non/Documents/ITI/Laravel/LaravleProject/mark.wahba33-gmail.com/vendor/jeroennoten/laravel-adminlte/src/../resources/views/partials/menu-item.blade.php ENDPATH**/ ?>