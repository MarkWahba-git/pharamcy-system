...
<div id="orderModal" class="modal fade" role="dialog">
  ...
  <!-- order insert -->
    ...
    $('#order_form').on('submit', function(event){
        ...
        $.ajax({
            url:"<?php echo e(route('drugs.postdrugs')); ?>",
            method:"POST",
            data:form_data,
            dataType:"json",
...
</html><?php /**PATH /media/ahmed/edu/ITI/laravel/laravel-project/mark.wahba33-gmail.com/resources/views/orders/index.blade.php ENDPATH**/ ?>