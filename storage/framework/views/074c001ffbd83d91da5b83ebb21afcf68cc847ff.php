...
$(document).ready(function() {
    ...
    $('#add_order_btn').click(function(){
     ...
     $('#order_table').DataTable({
        "processing": true,
        "serverSide": true,
        "ajax": "<?php echo e(route('orders.getdata')); ?>",
        "columns":[
            {data: 'id', name: 'id'},
            {data: 'name', name: 'name'},
...
$('#order_form').on('submit', function(event){
        ...
        $.ajax({
            url:"<?php echo e(route('orders.postorder')); ?>",
            method:"POST",
            data:form_data,
            dataType:"json",
    ...
    $(document).on('click', '.edit', function(){
        ...
        $('#form_output').html('');
        $.ajax({
            url:"<?php echo e(route('orders.fetchorder')); ?>",
            method:'get',
            data:{id:id},
            dataType:'json',
            success:function(data)
    ...
    $(document).on('click', '.delete', function(){
        ...
        {
            $.ajax({
                url:"<?php echo e(route('orders.removeorder')); ?>",
                mehtod:"get",
                data:{id:id},
                success:function(data)
                {
    ...
    $(document).on('click', '.adddrugs', function(){
        var id = $(this).attr('id');
            ...
            $.ajax({
                url:"<?php echo e(route('drugs.orderdrugs')); ?>",
                mehtod:"POST",
                data:{id:id},
                success:function(data)
                {
...
<?php /**PATH /media/ahmed/edu/ITI/laravel/laravel-project/mark.wahba33-gmail.com/resources/views/orders/index.blade.php ENDPATH**/ ?>